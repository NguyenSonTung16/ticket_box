...
import { OrganizerTopNav } from './organizer-center/components/OrganizerTopNav';
...
export const EventPage: React.FC = () => {
  ...
  return (
    <div className="bg-background text-on-surface font-body-md overflow-x-hidden">
      ...
      <main className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-[100px] space-y-margin-desktop">
        {error ? (
