...
(async () => {
  ...
  console.log(`🎯 Đang cuộn tìm ghế (${SEAT_TEXT}) ở cả 2 màn hình...`);
  ...
  await page1.waitForTimeout(2000); // Khán giả nhìn thấy ghế A-13 đang đỏ (Đang trống) ở cả 2 bên

  console.log('⚡ Cửa sổ 1 bắt đầu chọn và giữ ghế...');
  // Chỉ Cửa sổ 1 ấn chọn ghế và ấn Tiếp tục
  await page1.getByText(SEAT_TEXT, { exact: true }).dispatchEvent('click');
  await page1.waitForTimeout(500);
  await page1.getByRole('button', { name: 'Tiếp tục' }).click();

  console.log('👀 Cửa sổ 2 đang đứng im quan sát sự kiện SSE...');
  // Cửa sổ 2 không làm gì cả, chỉ chờ xem ghế A-13 có tự đổi màu xám không!
  
  // Khán giả nhìn 10 giây để thấy sự biến đổi thời gian thực
  await page1.waitForTimeout(10000);

  console.log('🎉 Xong! Xem kết quả trên màn hình!');
  // Giữ màn hình 10 giây để xem
  await page1.waitForTimeout(10000);
